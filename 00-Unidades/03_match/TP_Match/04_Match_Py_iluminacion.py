...
# ------- IF marca // MATCH cantidad -------
        ...
        if precio > 4000:
            descuento_dos= total * 0.05
        else:
            descuento_dos= 0

        precio_final= precio - descuento_dos

        alert("Lamparas", f"El valor, con el descuento aplicado, es de: {precio_final}")


'''
------- MATCH marca // IF cantidad -------

        if cant in [6,7,8,9,10,11,12]:
            descuento= 0.50
        elif cant == 5:
                match marca:
                    case "ArgentinaLuz":
